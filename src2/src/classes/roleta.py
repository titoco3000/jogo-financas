...
class Roleta(GameObject):
    def __init__(self, pos, radius):
        ...
        # Som de fundo contínuo da roleta
        self.som_roleta = pygame.mixer.Sound("sons/roleta.wav")
        self.som_roleta.set_volume(0.5)
        self.som_roleta.play(loops=-1)  # Toca continuamente enquanto a roleta está na tela
    ...
    def rodar(self):
        self.anim.reset()
        self.anim.play()
        # Removido: self.som_roleta.play(loops=-1)
    ...
    def update(self, events):
        ...
        # Removido: else: self.som_roleta.stop()
